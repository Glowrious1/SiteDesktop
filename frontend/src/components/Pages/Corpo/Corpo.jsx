...
export default function Corpo() {
  ...
  // ---- FILTRAR APENAS OS PRODUTOS DE Corpo ----
  const produtosCorpo = produtos.filter((p) => p.categoria === "Corpo");

  const userId = 1; // depois troca pelo user logado
  ...
  return (
    <div className="app">
      ...
      <section className="produtos">
        <h2>Produtos para Corpo</h2>

        <div className="lista-produtos">
          {produtosCorpo.map((item) => (
            <div
              key={item.id}
              className="card"
